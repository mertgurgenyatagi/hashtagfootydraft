...
is the average Derived Price across that episode's sampled player pool.
...
`start_training.bat`. This doesn't resolve the open question of what the bots' actual
