        ...
        {formats.map((format, index) => (
          <li key={format.id} className="fx fx-rise" style={{ animationDelay: `${960 + index * 70}ms` }}>
            ...
            <button
              ...
              className="group/format relative flex h-full w-full items-end overflow-hidden border border-line-strong bg-surface/70 px-3 py-2 text-left transition-[border-color,background-color] duration-100 ease-out hover:border-accent-line hover:bg-accent-soft focus-visible:border-accent-line sm:px-4 sm:py-[13px]"
            >
