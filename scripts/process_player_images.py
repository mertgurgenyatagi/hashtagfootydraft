...
Usage:
    python scripts/process_player_images.py                  # process all
    python scripts/process_player_images.py --limit 5         # test run
    python scripts/process_player_images.py --dry-run          # report only
"""
